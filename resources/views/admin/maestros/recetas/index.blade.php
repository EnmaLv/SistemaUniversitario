<x-app-layout>
    <div class="pt-6 pb-12 min-h-[calc(100vh-4rem)]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <a href="{{ route('admin.maestros.recetas.create') }}"
            ...
            <div style="background-color: var(--bg-card); border-color: var(--border-color);"
                ...
                <form action="{{ route('admin.maestros.recetas.index') }}" method="GET" class="relative w-full">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800/60 text-xs font-medium">
                            @forelse($recetas as $receta)
                                <x-table-row :id="$receta->id">
                                    ...
                                    <x-table-actions
                                        :id="$receta->id"
                                        baseUrl="admin/maestros/recetas"
    ...
    <script>
        document.getElementById('estadoToggle')?.addEventListener('change', function () {
            ...
            window.location.href = "{{ route('admin.maestros.recetas.index') }}?" + params.toString();
        });
    </script>
</x-app-layout>
