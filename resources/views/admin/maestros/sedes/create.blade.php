...
@section('content_header')
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Registra una nueva sede en el sistema.</p>
    </div>
@stop
...
@section('content')
    <div class="rounded-2xl border p-6 shadow-sm" style="background-color: var(--bg-card); border-color: var(--border-color);">
        <div class="mb-6 flex items-center justify-between border-b pb-4" style="border-color: var(--border-color);">
            <div><h2 class="text-lg font-bold" style="color: var(--text-main);">Datos de la sede</h2><p class="text-sm text-gray-500 dark:text-gray-400">Complete la informacion requerida.</p></div>
