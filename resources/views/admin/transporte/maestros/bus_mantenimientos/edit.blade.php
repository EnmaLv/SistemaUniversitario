...
@section('content_header')
    <div class="mb-6 flex flex-col gap-4 rounded-2xl border p-5 shadow-sm md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-2xl font-extrabold tracking-tight sm:text-3xl" style="font-size:1.4rem;">Editar Mantenimiento</h1>
...
@section('content')
    <div class="rd-card p-4">
        <div class="rd-card-header mb-3">
            <h3 class="rd-title-sm">Editar â€ <span style="color:var(--color-primary)">{{ $busMantenimiento->titulo }}</span></h3>
            <a href="{{ route('admin.transporte.maestros.bus_mantenimientos.index') }}" class="inline-flex items-center justify-center gap-2 rounded-xl border px-5 py-2.5 text-sm font-bold transition-all hover:bg-gray-100 dark:hover:bg-gray-800" style="border-color:var(--border-color);color:var(--text-main);">
        ...
        <form action="{{ route('admin.transporte.maestros.bus_mantenimientos.update', $busMantenimiento) }}" method="POST"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="font-weight-bold">PrÃ³ximo KM <span class="text-muted font-weight-normal">(opcional)</span></label>
                        <div class="flex items-center rounded-xl border border-slate-200 bg-slate-50 mt-1">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="font-weight-bold">PrÃ³xima Fecha <span class="text-muted font-weight-normal">(opcional)</span></label>
                        <div class="flex items-center rounded-xl border border-slate-200 bg-slate-50 mt-1">
