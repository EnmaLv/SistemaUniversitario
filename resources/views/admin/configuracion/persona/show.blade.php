    ...
    <div class="min-h-[calc(100vh-4rem)] px-4 pb-12 pt-6 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <div>
                    <h1 class="text-2xl font-extrabold tracking-tight sm:text-3xl" style="color: var(--text-main);">Datos del estudiante</h1>
            ...
            <div class="rounded-2xl border p-5 shadow-sm sm:p-6" style="background-color: var(--bg-card); border-color: var(--border-color);">
                <h2 class="mb-6 border-b pb-4 text-lg font-extrabold" style="border-color: var(--border-color); color: var(--text-main);">Información registrada</h2>
