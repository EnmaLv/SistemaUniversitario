            ...
            <div class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                    ...
                    <p class="mt-1 text-xs font-medium text-gray-500 dark:text-gray-400 sm:text-sm">
                        Registra un beneficio disponible para asociarlo a las becas.
                    </p>
                </div>
            ...
            <div class="overflow-hidden rounded-2xl border shadow-sm"
                ...
                <div class="border-b px-6 py-5" style="border-color: var(--border-color);">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Completa la información necesaria para crear el beneficio.
                    </p>
                </div>

                <form action="{{ route('admin.becas.beneficios.store') }}" method="POST"
