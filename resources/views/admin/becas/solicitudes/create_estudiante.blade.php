    ...
    <div class="pt-8 pb-12 min-h-[calc(100vh-4rem)]">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <a href="{{ route('admin.becas.solicitudes.index') }}" class="inline-flex items-center text-xs font-bold text-red-700 dark:text-red-400 uppercase tracking-widest hover:text-red-700 transition-colors mb-2">
                        <i class="fas fa-arrow-left mr-2"></i> Volver a mis solicitudes
                    </a>
                    <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight" style="color: var(--text-main);">
                        Postulación a Beneficio Estudiantil (Beca)
                    </h1>
                    <p class="mt-1 text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">
                        Completa tu expediente socioeconómico para registrar tu solicitud.
                    </p>
                </div>
            </div>
                ...
                <form id="solicitudForm" action="{{ route('admin.becas.solicitudes.store') }}" method="POST" class="p-8">
                    ...
                    <div id="step-content-1" class="step-pane">
                        <h4 class="text-lg font-black text-slate-800 dark:text-white uppercase tracking-tight mb-6 flex items-center gap-2">
                            <span>📝</span> Tus Datos Académicos
                        </h4>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            {{-- Estudiante (Autocompletado por el usuario logueado) --}}
                            <div>
                                <label class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Estudiante Solicitante</label>
                                <div class="bg-gray-100 dark:bg-gray-700 p-3 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 font-medium">CI: {{ auth()->user()->persona?->cedula_persona ?? 'No registrada' }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="beneficio_nombre_disabled" readonly
                                    class="w-full bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 outline-none cursor-not-allowed"
