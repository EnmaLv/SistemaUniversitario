<div>
    <div class="rounded-2xl border p-4 sm:p-5"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-start">
            <div class="lg:col-span-4">
                ...
                <div class="relative">
                    ...
                    <select @disabled($compra->estado == 'Enviado al proveedor') wire:model.live="productoId" id="nombre"
            ...
            <div class="sm:col-span-1 lg:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input @disabled($compra->estado == 'Enviado al proveedor') type="number" id="cantidad" wire:model="cantidad"
                        name="cantidad" placeholder="Ej: 2 cajas" value="{{ old('cantidad', $compra->cantidad) }}"
                        min="1"
            ...
            <div class="sm:col-span-1 lg:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input @disabled($compra->estado == 'Enviado al proveedor') type="number" wire:model="precioCompra" id="precioCompra"
                        name="precio_compra" placeholder="Precio" step="0.01"
        ...
        <div class="mt-4 pt-4 border-t flex items-center gap-2 text-[11px] font-medium text-gray-400"
            ...
            <i class="fas fa-info-circle text-[10px]"></i>
            <span>
                Selecciona un producto, verifica su lote, cantidad de envases y precio antes de agregarlo.
            </span>
        </div>
    </div>
                ...
                <table class="w-full text-sm">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-[10px] uppercase tracking-wider font-black text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                Lote
                            </th>
                            <th class="px-4 py-3 text-center text-[10px] uppercase tracking-wider font-black text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                Envases
                            </th>
                            <th class="px-4 py-3 text-center text-[10px] uppercase tracking-wider font-black text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                Unidad base
                            </th>
                            <th class="px-4 py-3 text-right text-[10px] uppercase tracking-wider font-black text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                Precio unitario
                            </th>
                            <th class="px-4 py-3 text-right text-[10px] uppercase tracking-wider font-black text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                Subtotal
                            </th>
                            <th class="px-4 py-3 text-center text-[10px] uppercase tracking-wider font-black text-gray-500 dark:text-gray-400">
                                Acción
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="divide-y" style="--tw-divide-opacity: 1;">
                        @foreach ($compra->detalleCompras as $detalle)
                            ...
                            <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-white/[0.02]"
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        <div
                                            ...
                                            <i class="fas {{ $esMedicina ? 'fa-pills' : 'fa-box' }} text-[10px]"></i>
                                        </div>
                                        <div class="min-w-0">
                                ...
                                <td class="px-4 py-3 text-center text-xs font-semibold"
                                    style="color: var(--text-main);">
                                    {{ number_format($detalle->cantidad_convertida, 0, ',', '.') }}
                                    <span class="text-[10px] font-normal text-gray-400 ml-0.5">{{ $unidadBase }}</span>
                                </td>
